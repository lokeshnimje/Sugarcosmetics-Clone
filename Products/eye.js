let list = document.getElementById("list").addEventListener("click",getItemlist)
        ...
        function getItem(){
            let url = `https://sugarcosmeticsdb1.herokuapp.com/eye`
...
function removeItems(e){
    ...
    function sort(){
        ...
        let sort=document.getElementById("select").value
        if( sort === "Price, low to high"){
            let url = `https://sugarcosmeticsdb1.herokuapp.com/eye?_sort=price&_order=asc`
            ...
            let url = `https://sugarcosmeticsdb1.herokuapp.com/eye?_sort=price&_order=desc`
